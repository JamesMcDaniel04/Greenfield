-- 0019: 'career' plan tier + monthly usage counter
--
-- The Career tier unlocks the AI Automation Specialist track + mentor and
-- evaluator agent runs against submissions. Combined monthly quota is
-- enforced server-side in run-agent (and pre-checked in submit-project).
-- Mirrors the BYO usage counter pattern from 0014.
...
----------------------------------------------------------------------
-- 4. sync_team_plan_defaults: mirror the new column onto teams
----------------------------------------------------------------------
...
----------------------------------------------------------------------
-- 5. Monthly career usage counter, parallel to byo_usage_monthly
----------------------------------------------------------------------
create table public.career_usage_monthly (
...
----------------------------------------------------------------------
-- 6. Trigger: bump career_usage_monthly on every submission-scoped agent_run
